...
function getColorBySize(bbox) { return "yellow";
...
async 
// Store object details in local storage
function storeObjectDetails(predictions) {
...
function drawPredictions(predictions) { storeObjectDetails(predictions);
